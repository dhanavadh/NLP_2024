...
>[!Note]
>เทคนิคการประเมินประสิทธิภาพของ Machine Learning ด้วย Confusion matrix โดยตารางนี้จะทำงานร่วมกับชุดข้อมูลที่เราทราบผลจริงแล้ว โดยจะเปรียบเทียบค่าจริง กับค่าที่คาดการณ์จากโมเดล ซึ่งก่อนอื่นขอพาทุกท่านไปรู้จักองค์ประกอบของตาราง (แสดงในตารางที่ 1) ดังนี้:
